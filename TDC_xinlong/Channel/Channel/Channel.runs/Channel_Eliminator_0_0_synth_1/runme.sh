...
HD_PWD='D:/work_directory/TDC/Channel/Channel/Channel.runs/Channel_Eliminator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Channel_Eliminator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Channel_Eliminator_0_0.tcl
