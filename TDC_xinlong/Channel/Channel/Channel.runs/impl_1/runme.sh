...
HD_PWD='D:/work_directory/TDC/Channel/Channel/Channel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Channel_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Channel_wrapper.tcl -notrace
