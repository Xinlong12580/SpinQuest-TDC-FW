...
HD_PWD='D:/work_directory/TDC/Channel/Channel/Channel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Channel_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Channel_wrapper.tcl
