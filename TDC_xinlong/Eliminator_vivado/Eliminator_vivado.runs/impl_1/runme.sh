...
HD_PWD='D:/work_directory/TDC/Eliminator_vivado/Eliminator_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Eliminator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Eliminator.tcl -notrace
