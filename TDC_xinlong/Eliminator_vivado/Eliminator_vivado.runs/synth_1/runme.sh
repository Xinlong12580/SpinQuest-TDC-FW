...
HD_PWD='D:/work_directory/TDC/Eliminator_vivado/Eliminator_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Eliminator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Eliminator.tcl
