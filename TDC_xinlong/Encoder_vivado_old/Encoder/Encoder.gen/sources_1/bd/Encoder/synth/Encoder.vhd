...
entity Encoder is
  ...
  attribute CORE_GENERATION_INFO of Encoder : entity is "Encoder,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Encoder,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of Encoder : entity is "Encoder.hwdef";
end Encoder;

architecture STRUCTURE of Encoder is
  component Encoder_encoder_0_0 is
  port (
  ...
  end component Encoder_encoder_0_0;
...
encoder_0: component Encoder_encoder_0_0
     port map (
