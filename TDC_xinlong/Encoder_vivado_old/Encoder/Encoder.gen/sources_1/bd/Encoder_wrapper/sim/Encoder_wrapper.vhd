...
entity Encoder_wrapper is
  ...
  attribute CORE_GENERATION_INFO of Encoder_wrapper : entity is "Encoder_wrapper,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Encoder_wrapper,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of Encoder_wrapper : entity is "Encoder_wrapper.hwdef";
end Encoder_wrapper;

architecture STRUCTURE of Encoder_wrapper is
  component Encoder_wrapper_encoder_0_0 is
  port (
  ...
  end component Encoder_wrapper_encoder_0_0;
...
encoder_0: component Encoder_wrapper_encoder_0_0
     port map (
