...
#                script (type 'Encoder_interface.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Encoder_interface -o Encoder_interface_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Encoder_interface_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Encoder_interface_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Encoder_interface_simv.daidir vcs_lib c.obj)
