...
#
# Script generated by Vivado on Thu Apr 25 16:07:27 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Encoder_interface.sh
...
#
# Usage        : Encoder_interface.sh
#                Encoder_interface.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Encoder_interface.sh [-reset_run]
#                Encoder_interface.sh [-reset_log]
#                Encoder_interface.sh [-help]
#
...
# script info
echo -e "Encoder_interface.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Encoder_interface.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot Encoder_interface xil_defaultlib.Encoder_interface -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Encoder_interface -key {Behavioral:sim_1:Functional:Encoder_interface} -tclbatch cmd.tcl -protoinst "protoinst_files/Encoder_interface.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Encoder_interface.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Encoder_interface.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Encoder_interface.sh [-help]\n\
Usage: Encoder_interface.sh [-step]\n\
Usage: Encoder_interface.sh [-lib_map_path]\n\
Usage: Encoder_interface.sh [-reset_run]\n\
Usage: Encoder_interface.sh [-reset_log]\n\
Usage: Encoder_interface.sh [-keep_index]\n\
Usage: Encoder_interface.sh [-noclean_files]\n\n\
