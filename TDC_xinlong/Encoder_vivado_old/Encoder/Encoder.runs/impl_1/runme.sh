...
HD_PWD='D:/work_directory/TDC/Encoder_vivado/Encoder/Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Encoder_interface_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Encoder_interface_wrapper.tcl -notrace
