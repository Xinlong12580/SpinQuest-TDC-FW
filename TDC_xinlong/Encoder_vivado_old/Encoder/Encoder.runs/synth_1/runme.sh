...
HD_PWD='D:/work_directory/TDC/Encoder_vivado/Encoder/Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Encoder_interface_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Encoder_interface_wrapper.tcl
