...
HD_PWD='D:/work_directory/TDC/Main_Counter/Main_Counter/Main_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_Counter.tcl -notrace
