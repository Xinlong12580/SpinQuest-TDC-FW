...
HD_PWD='D:/work_directory/TDC/Main_Counter/Main_Counter/Main_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_Counter.tcl
