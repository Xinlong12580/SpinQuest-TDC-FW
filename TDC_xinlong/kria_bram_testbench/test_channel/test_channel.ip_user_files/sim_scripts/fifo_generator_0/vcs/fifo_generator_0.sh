...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/work_directory/test/test_channel/test_channel.cache/compile_simlib/vcs"
  fi
