...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/work_directory/test/test_channel/test_channel.cache/compile_simlib/xcelium"
  fi
