...
design_libs=(xilinx_vip xpm xil_defaultlib axi_bram_ctrl_v4_1_9 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_31)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/ec67/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/2fcd/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/35de/hdl/verilog" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/ec67/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/2fcd/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/35de/hdl/verilog" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.testbram_v3 xil_defaultlib.glbl -o testbram_v3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./testbram_v3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key testbram_v3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc testbram_v3_simv.daidir vcs_lib c.obj)
