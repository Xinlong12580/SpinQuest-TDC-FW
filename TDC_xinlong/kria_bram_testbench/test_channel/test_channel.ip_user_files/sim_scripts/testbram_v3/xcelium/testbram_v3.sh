...
#
# Script generated by Vivado on Tue Jul 09 12:36:43 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : testbram_v3.sh
...
#
# Usage        : testbram_v3.sh
#                testbram_v3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                testbram_v3.sh [-reset_run]
#                testbram_v3.sh [-reset_log]
#                testbram_v3.sh [-help]
#
...
#                script (type 'testbram_v3.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_bram_ctrl_v4_1_9 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_31 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_bram_ctrl_v4_1_9 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_31)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "testbram_v3.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./testbram_v3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/ec67/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/2fcd/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/35de/hdl/verilog" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/ec67/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/2fcd/hdl" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_channel.gen/sources_1/bd/testbram_v3/ipshared/35de/hdl/verilog" +incdir+"D:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.testbram_v3 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.testbram_v3 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log testbram_v3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./testbram_v3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: testbram_v3.sh [-help]\n\
Usage: testbram_v3.sh [-step]\n\
Usage: testbram_v3.sh [-lib_map_path]\n\
Usage: testbram_v3.sh [-reset_run]\n\
Usage: testbram_v3.sh [-reset_log]\n\
Usage: testbram_v3.sh [-keep_index]\n\
Usage: testbram_v3.sh [-noclean_files]\n\n\
