...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_bram_ctrl_v4_1_9 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_31 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot testbram_v3 xil_defaultlib.testbram_v3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim testbram_v3 -key {Behavioral:sim_1:Functional:testbram_v3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6c06.protoinst" -protoinst "protoinst_files/testbram_v3.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testbram_v3.wdb xsim.dir libdpi.so)
