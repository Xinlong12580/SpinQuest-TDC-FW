...
HD_PWD='D:/work_directory/test/test_channel/test_channel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testbram_v3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testbram_v3_wrapper.tcl -notrace
