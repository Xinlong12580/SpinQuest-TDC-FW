...
HD_PWD='D:/work_directory/test/test_channel/test_channel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbram_v3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbram_v3_wrapper.tcl
