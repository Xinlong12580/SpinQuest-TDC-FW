...
HD_PWD='D:/work_directory/test/test_channel/test_channel.runs/testbram_v3_channel_setter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbram_v3_channel_setter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbram_v3_channel_setter_0_0.tcl
