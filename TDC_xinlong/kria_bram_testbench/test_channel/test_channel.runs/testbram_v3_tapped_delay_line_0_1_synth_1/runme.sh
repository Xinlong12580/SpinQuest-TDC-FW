...
HD_PWD='D:/work_directory/test/test_channel/test_channel.runs/testbram_v3_tapped_delay_line_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbram_v3_tapped_delay_line_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbram_v3_tapped_delay_line_0_1.tcl
